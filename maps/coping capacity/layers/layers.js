...
var format_COPINGCAPACITY_1 = new ol.format.GeoJSON();
var features_COPINGCAPACITY_1 = format_COPINGCAPACITY_1.readFeatures(json_COPINGCAPACITY_1, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_COPINGCAPACITY_1 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_COPINGCAPACITY_1.addFeatures(features_COPINGCAPACITY_1);
var lyr_COPINGCAPACITY_1 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_COPINGCAPACITY_1, 
                style: style_COPINGCAPACITY_1,
                popuplayertitle: 'COPING CAPACITY',
                interactive: true,
    title: 'COPING CAPACITY<br />\
    <img src="styles/legend/COPINGCAPACITY_1_0.png" /> Very Low<br />\
    <img src="styles/legend/COPINGCAPACITY_1_1.png" /> Low<br />\
    <img src="styles/legend/COPINGCAPACITY_1_2.png" /> Moderate<br />\
    <img src="styles/legend/COPINGCAPACITY_1_3.png" /> High<br />\
    <img src="styles/legend/COPINGCAPACITY_1_4.png" /> Very HIgh<br />' });

lyr_GoogleSatellite_0.setVisible(true);lyr_COPINGCAPACITY_1.setVisible(true);
var layersList = [lyr_GoogleSatellite_0,lyr_COPINGCAPACITY_1];
lyr_COPINGCAPACITY_1.set('fieldAliases', {'adm1_psgc': 'adm1_psgc', 'adm2_psgc': 'adm2_psgc', 'adm3_psgc': 'adm3_psgc', 'adm4_psgc': 'adm4_psgc', 'adm4_en': 'Barangay', 'geo_level': 'geo_level', 'len_crs': 'len_crs', 'area_crs': 'area_crs', 'len_km': 'len_km', 'area_km2': 'area_km2', 'h1': 'h1', 'h2': 'h2', 'E1': 'E1', 'E2': 'E2', 'V1': 'V1', 'C1': 'C1', 'C2': 'C2', 'E': 'E', 'H': 'H', 'V': 'V', 'C': 'C', 'R': 'R', 'R H': 'R H', 'R V': 'R V', 'R E': 'R E', 'R C': 'R C', 'R R': 'R R', });
...
lyr_COPINGCAPACITY_1.on('precompose', function(evt) {
