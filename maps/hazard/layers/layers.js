...
var format_HAZARD_3 = new ol.format.GeoJSON();
var features_HAZARD_3 = format_HAZARD_3.readFeatures(json_HAZARD_3, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_HAZARD_3 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_HAZARD_3.addFeatures(features_HAZARD_3);
var lyr_HAZARD_3 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_HAZARD_3, 
                style: style_HAZARD_3,
                popuplayertitle: 'HAZARD',
                interactive: true,
    title: 'HAZARD<br />\
    <img src="styles/legend/HAZARD_3_0.png" /> Very Low<br />\
    <img src="styles/legend/HAZARD_3_1.png" /> Low<br />\
